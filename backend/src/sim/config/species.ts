...
export const CHICKEN_SPECIES: SpeciesConfig = {
    ...
    utility: {
        base: {
            ...
            hunt: -999, rummage: -999, forage: 0.08,
        },
...
export const SMALL_BIRD_SPECIES: SpeciesConfig = {
    ...
    utility: {
        base: {
            ...
            hunt: -999, rummage: -999, forage: 0.06,
        },
...
export const RACCOON_SPECIES: SpeciesConfig = {
    ...
    utility: {
        base: {
            ...
            hunt: -999, rummage: 0.1, forage: -999,
        },
...
export const CROW_SPECIES: SpeciesConfig = {
    ...
    utility: {
        base: {
            ...
            hunt: -999, rummage: -999, forage: 0.07,
        },
...
export const DOG_SPECIES: SpeciesConfig = {
    ...
    utility: {
        base: {
            ...
            hunt: 0.05, rummage: -999, forage: -999,
        },
        urgency: { fear: 0.0, hunger: 1.4, thirst: 1.6, fatigue: 0.7 },
        bonuses: { nearBush: 0.1, nearWater: 0.2, nearTrash: 0.1, seesPrey: 0.4 },
...
export const FOX_SPECIES: SpeciesConfig = {
    ...
    utility: {
        base: {
            ...
            hunt: 0.1, rummage: -999, forage: -999,
        },
...
export const WOLF_SPECIES: SpeciesConfig = {
    ...
    utility: {
        base: {
            ...
            hunt: 0.15, rummage: -999, forage: -999,
        },
...
export const HAWK_SPECIES: SpeciesConfig = {
    ...
    utility: {
        base: {
            ...
            hunt: 0.2, rummage: -999, forage: -999,
        },
